...
const StGanpatUniversity = () => {
  const navigation = useNavigation();

  return (
    <View style={styles.stGanpatUniversity}>
...
15000/-`}</Text>
          ...
          <Text style={[styles.availableCourses1, styles.khervaGujaratTypo]}>
            Available Courses
          </Text>
        </View>
        ...
        <View style={[styles.about, styles.aboutPosition]}>
          <Text
            style={[styles.khervaGujarat, styles.khervaGujaratTypo]}
...
bla bla bla bla bla bla bla bla`}</Text>
      ...
      <View style={styles.ganpatUniversity}>
        <View style={styles.ganpatUniversityChild} />
        <Text style={[styles.ganpatUniversity1, styles.textFlexBox]}>
          Ganpat University
        </Text>
      </View>
      <Image
...
export default StGanpatUniversity;
